...
export module ui.Pages {
    export class GameUI extends Laya.Scene {
		...
		public scoreNumber:laya.display.Text;
		public restartBtn:Laya.Sprite;
        constructor(){ super()}
        createChildren():void {
